...
# BatteryWarning add by lishengli 20141017	tinno charge temp manage 
PRODUCT_PACKAGES += \
    BatteryWarning \
    batterywarning
...
#Begin yutao,xiongdajun 2015.05.15 Diract effects
#$(call inherit-product, vendor/tinno/packages/apks/myos/tinno_myos.mk)
...
#End yutao,xiongdajun 2015.05.15 Diract effects
	   
#add widevine
BOARD_WIDEVINE_OEMCRYPTO_LEVEL := 3
ifdef BOARD_WIDEVINE_OEMCRYPTO_LEVEL 
PRODUCT_PACKAGES += libWVStreamControlAPI_L$(BOARD_WIDEVINE_OEMCRYPTO_LEVEL) \
...
PRODUCT_PROPERTY_OVERRIDES += drm.service.enabled = true \
                              keyguard.no_renewquire_sim=true 
